...
$work = [
	[
        ...
        'functions' => 'Банальные, но неопровержимые выводы, а также 
        cтремящиеся вытеснить традиционное производство, нанотехнологии 
        освещают чрезвычайно интересные особенности картины в целом, 
        однако конкретные выводы, разумеется, рассмотрены исключительно 
        в разрезе маркетинговых и финансовых предпосылок.',
    ],
    [
        'post' => 'Главный специалист / Министерство сельского хозяйства Челябинской области',
        'startDate' => 'Март 2019',
        'endDate' => 'Май 2020',
        'functions' => 'Являясь всего лишь частью общей картины, 
        элементы политического процесса своевременно верифицированы.
        Как уже неоднократно упомянуто, многие известные личности, которые 
    ...
    [
        'post' => 'Менеджер по персоналу / МЧС России по городу Севастополю',
        'startDate' => 'Март 2015',
        'endDate' => 'Август 2018',
        'functions' => 'Современные технологии достигли такого уровня, 
        то социально-экономическое развитие говорит о возможностях 
        вывода текущих активов. Вот вам яркий пример современных 
        тенденций — граница обучения кадров является качественно новой 
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for($i = 0; $i < count($work); $i++): ?>  
            <div class="w3-container">
                <h5 class="w3-opacity"><b><?php echo $work[$i]['post']; ?></b></h5>
